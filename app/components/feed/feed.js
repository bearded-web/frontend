        ...
        return (
            <div>
                <div className="feed-activity-list">
                    ...
                    <div className="feed-element">
                        <a href="#" className="pull-left">
                            <img alt="image" className="img-circle" src="http://webapplayers.com/inspinia_admin-v1.8/img/profile.jpg"/>
                        </a>
                        <div className="media-body ">
                    ...
                    <div className="feed-element">
                        <a href="#" className="pull-left">
                            <img alt="image" className="img-circle" src="http://webapplayers.com/inspinia_admin-v1.8/img/a2.jpg"/>
                        </a>
                        <div className="media-body ">
                    ...
                    <div className="feed-element">
                        <a href="#" className="pull-left">
                            <img alt="image" className="img-circle" src="http://webapplayers.com/inspinia_admin-v1.8/img/a3.jpg"/>
                        </a>
                        <div className="media-body ">
                            <small className="pull-right">2h ago</small>
                        ...
                        .
                            ...
                            <div className="photos">
                                <a target="_blank" href="http://24.media.tumblr.com/20a9c501846f50c1271210639987000f/tumblr_n4vje69pJm1st5lhmo1_1280.jpg">
                                    <img alt="image" className="feed-photo" src="http://webapplayers.com/inspinia_admin-v1.8/img/p1.jpg"/>
                                </a>
                                <a target="_blank" href="http://37.media.tumblr.com/9afe602b3e624aff6681b0b51f5a062b/tumblr_n4ef69szs71st5lhmo1_1280.jpg">
                                    <img alt="image" className="feed-photo" src="http://webapplayers.com/inspinia_admin-v1.8/img/p3.jpg"/>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div className="feed-element">
                        <a href="#" className="pull-left">
                            <img alt="image" className="img-circle" src="http://webapplayers.com/inspinia_admin-v1.8/img/a4.jpg"/>
                        </a>
                        <div className="media-body ">
                    ...
                    <div className="feed-element">
                        <a href="#" className="pull-left">
                            <img alt="image" className="img-circle" src="http://webapplayers.com/inspinia_admin-v1.8/img/a5.jpg"/>
                        </a>
                        <div className="media-body ">
                            <small className="pull-right">2h ago</small>
                    ...
                    <div className="feed-element">
                        <a href="#" className="pull-left">
                            <img alt="image" className="img-circle" src="http://webapplayers.com/inspinia_admin-v1.8/img/a7.jpg"/>
                        </a>
                        <div className="media-body ">
